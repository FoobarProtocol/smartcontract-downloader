...
Further processing scripts are available at [verified-smart-contracts](https://github.com/foobarprotocol/verified-smart-contracts).
...
smart-contract-downloader is licensed under the [MIT License](https://github.com/foobarprotocol/smart-contract-downloader/blob/main/LICENSE).  
